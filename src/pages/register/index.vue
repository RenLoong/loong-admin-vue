                ...
                <el-form ref="loginFormRef" :model="form" :rules="rules" class="login-form bg-filter" label-position="top"
                    ...
                    <div class="flex-1 w-60 mx-auto flex flex-center flex-column">
                        <el-form-item :label="t('register.label.username')" class="w-100" prop="username">
                            <el-input v-model="form.username" maxlength="11" :placeholder="t('register.usernamePlaceholder')" size="large"></el-input>
                        </el-form-item>
                        <el-form-item :label="t('register.label.captcha')" class="w-100" prop="captcha">
                            <el-input v-model="form.captcha" :placeholder="t('register.captchaPlaceholder')" size="large">
                                <template #append>
                        ...
                        <el-form-item :label="t('register.label.vcode')" class="w-100" prop="vcode">
                            <el-input v-model="form.vcode" :placeholder="t('register.vcodePlaceholder')" size="large" maxlength="6">
                                <template #append>
                                    <div class="px-3">
                                        <el-link
                        ...
                        <el-form-item :label="t('register.label.password')" class="w-100" prop="password">
                            <el-input type="password" show-password v-model="form.password" :placeholder="t('register.passwordPlaceholder')"
                                size="large"></el-input>
                        </el-form-item>
                    </div>
                    ...
                    <div class="py-4 flex flex-center text-info" v-if="WEBCONFIG.login.link_text">
                        <el-link href="#/login" type="primary" underline="never">{{ WEBCONFIG.login.link_text }}</el-link>
                    </div>
