...
const autoHidePopover=(e:MouseEvent)=>{
    ...
    if(!markedEditorToolbarRef.value){
        return;
    }
...
<template>
    <div class="marked-editor" ref="markedEditorRef" :class="{ 'marked-editor-full-screen': isFullScreen }">
        <div class="marked-editor-toolbar" ref="markedEditorToolbarRef">
            ...
            <el-popover placement="bottom" :visible="groupPopover==='code'" :width="400" trigger="click" :teleported="false">
                <template #reference>
                ...
                <template #dropdown>
                    <div class="marked-editor-toolbar-table" @mouseout="hoverTableColumn()">
                        <div class="marked-editor-toolbar-table-column" v-for="item in TableData"
                            ...
                            @mouseenter="hoverTableColumn(item.num)" @click="insertTable({ x: item.x, y: item.y })"></div>
                    </div>
                </template>
            </el-dropdown>
            <span class="marked-editor-toolbar-hr" />
            <el-popover placement="bottom" :visible="groupPopover==='link'" :width="400" trigger="click" :teleported="false">
                <template #reference>
            ...
            <el-popover placement="bottom" :visible="groupPopover==='image'" :width="400" trigger="click" :teleported="false">
                <template #reference>
