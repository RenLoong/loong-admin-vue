...
<template>
    <img v-if="WEBCONFIG.logo_use === 'image' && showLogoWhite" :src="WEBCONFIG.web_logo_light"
        class="logo-svg">
    <img v-else-if="WEBCONFIG.logo_use === 'image'" :src="WEBCONFIG.web_logo_dark" class="logo-svg">
